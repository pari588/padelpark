...
function loginname($value) { return  preg_match("/^[A-Za-z0-9_]{4,100}$/",$value); }
...
class mxValidate {
    ...
    function __construct($arrV) {
        ...
        $this->msg = array(
            ...
            'loginname' => '{TITLE} should be more that 4 characters, can contain only letters, numbers, and underscores',
